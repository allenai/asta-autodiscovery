...
IMAGE_TAG ?= dev
SCRIPTS_IMAGE = us-west1-docker.pkg.dev/ai2-aristo/autodiscovery/autodiscovery-scripts
REPLAY_IMAGE = us-west1-docker.pkg.dev/ai2-aristo/autodiscovery/autodiscovery-replay
AUTODISCOVERY_IMAGE = us-west1-docker.pkg.dev/ai2-aristo/autodiscovery/autodiscovery
