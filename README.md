...
* A [TypeScript](https://www.typescriptlang.org/), [React](https://reactjs.org/)
  and [Shellac](https://varnish.allenai.org/material-ui/varnish/shellac/) based user interface (uses only HTML and CSS).
...
To deploy your application to Skiff it'll need to be [onboarded](https://skiff.allenai.org/onboarding.html).
...
You can find more details about your application via [Marina](https://marina.apps.allenai.org/a/asta-autodiscovery).

## Getting Help

See [Skiff's Documentation](https://skiff.allenai.org/) for more information.
