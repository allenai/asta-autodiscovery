...
#   gsutil ls gs://ai2-autodiscovery/users/user123/jobs/job1/output/
#
#   # List output files recursively
#   gsutil ls -r gs://ai2-autodiscovery/users/user123/jobs/job1/output/
#
#   # Download all outputs to local directory
#   gsutil -m cp -r gs://ai2-autodiscovery/users/user123/jobs/job1/output/ ./local_output/
#
#   # Download a specific file
#   gsutil cp gs://ai2-autodiscovery/users/user123/jobs/job1/output/results.json ./results.json
#
#   # View a specific file without downloading
#   gsutil cat gs://ai2-autodiscovery/users/user123/jobs/job1/output/log.txt
#
