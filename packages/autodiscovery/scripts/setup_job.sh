...
#   ./scripts/setup_job.sh reecea job1 ./discoverybench/real/test/nls_ses/ ./discoverybench/real/test/metadata.json
#
#   # Upload single file
#   ./scripts/setup_job.sh reecea job2 ./discoverybench/real/test/nls_ses/nls_ses_processed.csv ./discoverybench/real/test/nls_ses/metadata.json
#
