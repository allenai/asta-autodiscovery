...
class ArgParser(argparse.ArgumentParser):
    def __init__(self, group=None):
        ...
        self.add_argument(
            "--n_experiments",
            type=int,
            help="Number of MCTS iterations (max_iterations)",
            required=True,
        )
        self.add_argument(
            "--batch_size",
        ...
        self.add_argument(
            "--k_experiments", type=int, default=8, help="Branching factor for experiments (>= 1)"
        )
        self.add_argument(
            "--allow_generate_experiments",
        ...
        self.add_argument(
            "--exploration_weight",
            type=float,
            help="Exploration weight for UCB1 selection method",
            default=2.0,
        )
        self.add_argument(
        ...
        self.add_argument(
            "--beam_width", type=int, default=8, help="Beam width for beam search selection method"
        )
        self.add_argument(
            "--use_beam_search",
            action=argparse.BooleanOptionalAction,
        ...
        self.add_argument(
            "--pw_alpha", type=float, help="Progressive widening exponent alpha", default=0.5
        )
        self.add_argument(
            "--k_parents",
            type=int,
