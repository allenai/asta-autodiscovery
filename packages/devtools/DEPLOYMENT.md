...
docker build --platform linux/amd64 \
  -t us-west1-docker.pkg.dev/ai2-aristo/autodiscovery/autodiscovery-replay:dev \
  -f packages/devtools/Dockerfile .

# Push to Artifact Registry
docker push us-west1-docker.pkg.dev/ai2-aristo/autodiscovery/autodiscovery-replay:dev
```
