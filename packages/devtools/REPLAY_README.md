...
execution_id = manager.run_job(
    userid, jobid,
    test_mode=True,
    replay_source="gs://ai2-autodiscovery/users/template/jobs/melanoma/output",
...
replay_autodiscovery(
    source_path="gs://ai2-autodiscovery/users/alice/jobs/melanoma/output",
    target_path="gs://ai2-autodiscovery/users/alice/jobs/test-run-123/output",
...
Replay AutoDiscovery Run
  Source: gs://ai2-autodiscovery/users/alice/jobs/melanoma/output
  Target: gs://ai2-autodiscovery/users/bob/jobs/test-123/output
  Files: 206
  Time scale: 0.1x
