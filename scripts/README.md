...
```bash
docker build --platform linux/amd64 -t us-west1-docker.pkg.dev/ai2-aristo/autodiscovery/autodiscovery-scripts:dev -f scripts/Dockerfile .
docker push us-west1-docker.pkg.dev/ai2-aristo/autodiscovery/autodiscovery-scripts:dev
```
