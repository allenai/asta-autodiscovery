...
All maintenance scripts are packaged into a single container image: `gcr.io/ai2-aristo/autodiscovery-maintenance`
...
```bash
docker build --platform linux/amd64 -t gcr.io/ai2-aristo/autodiscovery-maintenance -f scripts/Dockerfile .
docker push gcr.io/ai2-aristo/autodiscovery-maintenance
```
...
gcloud run jobs create autodiscovery-dataset-cleanup \
  --image gcr.io/ai2-aristo/autodiscovery-maintenance \
  --region us-west1 \
