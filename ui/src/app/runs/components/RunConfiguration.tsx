  ...
  return (
    <Box sx={{ maxWidth: 'md', mx: 'auto', p: 3 }}>
      ...
      <Typography variant="body2" color="text.secondary" paragraph>
        Set the parameters for your autodiscovery run. You can adjust these
        settings based on your experimental requirements.
      </Typography>
      ...
      <Paper sx={{ p: 2, bgcolor: 'grey.50' }}>
        <Typography variant="caption" color="text.secondary">
          ...
          execution. You&apos;ll receive an execution ID to track the progress
          of your run.
        </Typography>
      </Paper>
    </Box>
